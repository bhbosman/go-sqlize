...
func (compiler *Compiler) executeBlockStmt(state State, node Node[*ast.BlockStmt], typeParams ITypeMapperArray, unprocessedArgs []Node[ast.Node]) ([]Node[ast.Node], CallArrayResultType) {
